...
# iowa_rec18_dum <- read.csv("/Users/chaenni/Documents/UCONN/Research/Paper1-Recidivism CRM/data_files/iowa18.csv")
...
wb_sample <- stan_model("/home/chy20005/Recidivism/simulation/wb1.stan")
...
saveRDS(wb_sample_fit, "/home/chy20005/Recidivism/simulation/res/wb1.rds")
