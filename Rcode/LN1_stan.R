...
# ln_sample <- stan_model("/home/chy20005/Recidivism/Recidivism_rstan/aft_lognormal.stan")
...
# 
# saveRDS(ln_sample_fit, "/home/chy20005/res/ln_sample1.rds")



ln_sample <- stan_model("/home/chy20005/Recidivism/simulation/LN1.stan")
ln_sample_fit <- sampling(ln_sample, data = iowa18_stan, seed = 12345, chains = 4, iter = 2000, init = 0, 
                          pars = c("betaU", "betaC", "sigma", "lp__", "log_lik"))

saveRDS(ln_sample_fit, "/home/chy20005/Recidivism/simulation/res/ln1.rds")
