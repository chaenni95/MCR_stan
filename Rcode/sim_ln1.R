...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/LN1.stan")

# stanmodel <- stan_model("/Users/chaenni/Documents/UCONN/Research/Paper1/simulation/LN1.stan")
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simln1.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simln1_summary.rds")
