...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/LLG1.stan")
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simllg1.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simllg1_summary.rds")
