...
geraMCM.WB <- function(n, x, w, censoring_time=10 , beta=c(1,2), eta=c(1,2), alpha=1.5, link="rplogit", tau=1.5, delta = 1){
...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/wb3.stan")
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simwb3.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simwb3_summary.rds")
