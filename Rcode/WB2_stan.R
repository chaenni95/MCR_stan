...
# wb_sample <- stan_model("/home/chy20005/Recidivism/Recidivism_rstan/aft_weibull_pl.stan")
...
# 
# saveRDS(wb_sample_fit, "/home/chy20005/res/res_stan_fix_0528/weibull_sample2.rds")
# 
# 

wb_sample <- stan_model("/home/chy20005/Recidivism/simulation/wb2.stan")
#wb_sample <- stan_model("/Users/chaenni/Documents/UCONN/rstan/weibull_sample.stan")
wb_sample_fit <- sampling(wb_sample, data = iowa18_stan, seed = 12345, chains = 4, iter = 2000, init = 0, 
                          pars = c("betaU", "betaC", "sigma", "delta", "lp__", "log_lik"))

saveRDS(wb_sample_fit, "/home/chy20005/Recidivism/simulation/res/wb2.rds")
