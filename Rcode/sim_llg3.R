...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/LLG3.stan")
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simllg3.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simllg3_summary.rds")
