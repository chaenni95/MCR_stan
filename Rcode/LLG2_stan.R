...
# llog_sample <- stan_model("/home/chy20005/Recidivism/Recidivism_rstan/aft_llogistic_pl.stan")
...
#                             pars = c("betaU", "betaC", "sigma","delta", "lp__", "log_lik", "y_rep", "pp"))
# 
# saveRDS(llog_sample_fit, "/home/chy20005/res/res_stan_fix_0528/llog_sample2.rds")

llg_sample <- stan_model("/home/chy20005/Recidivism/simulation/LLG2.stan")
...
saveRDS(llg_sample_fit, "/home/chy20005/Recidivism/simulation/res/llg2.rds")
