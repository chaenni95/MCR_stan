...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/wb1.stan")
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simwb1.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simwb1_summary.rds")
