...
# llog_sample <- stan_model("/home/chy20005/Recidivism/Recidivism_rstan/aft_llogistic.stan")
...
#                             pars = c("betaU", "betaC", "sigma", "lp__", "log_lik", "y_rep", "pp"))
# 
# saveRDS(llog_sample_fit, "/home/chy20005/res/llog_sample1.rds")
# 

llg_sample <- stan_model("/home/chy20005/Recidivism/simulation/LLG1.stan")
...
saveRDS(llg_sample_fit, "/home/chy20005/Recidivism/simulation/res/llg1.rds")
