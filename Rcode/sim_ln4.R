...
geraMCM.Lognormal <- function(n, x, w, censoring_time = 10, beta = c(1, 2), eta = c(1, 2), 
                              alpha = 1, link = "fglogit", tau = 1.5, delta = 1) {
...
stanmodel <- stan_model("/home/chy20005/Recidivism/simulation/LN4.stan")

for (i in 1:num_reps) {
  
  # Step 1: Generate a new dataset (modify this function to fit your simulation setup)
  data <- geraMCM.Lognormal(n, x, w, censoring_time=censoring_time , beta=beta, eta=eta, alpha=alpha, link="fglogit", tau=1.5, delta = 2)  # Custom function to simulate data
...
saveRDS(results, "/home/chy20005/Recidivism/simulation/res2/simln4.rds")
...
saveRDS(summarize_simulations(simulation_summaries), "/home/chy20005/Recidivism/simulation/res2/simln4_summary.rds")
