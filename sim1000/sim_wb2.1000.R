...
stanmodel <- stan_model("~/Recidivism/simulation/wb2.stan")
...
saveRDS(results, "~/Recidivism/res1000/simwb2.rds")



# Step 2: Apply the function to all simulation results
simulation_summaries <- lapply(results, extract_results)
# saveRDS(simulation_summaries, "~/Recidivism/res1000/simwb2_summary.rds")
