...
stanmodel <- stan_model("~/Recidivism/simulation/LN4.stan")

# stanmodel <- stan_model("/Users/chaenni/Documents/UCONN/Research/Paper1/simulation/LN4.stan")
...
saveRDS(results, "~/Recidivism/res/simln4.rds")



# Step 2: Apply the function to all simulation results
simulation_summaries <- lapply(results, extract_results)
saveRDS(simulation_summaries, "~/Recidivism/res1000/simln4_summary.rds")
