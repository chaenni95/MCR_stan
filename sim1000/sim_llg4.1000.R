...
stanmodel <- stan_model("~/Recidivism/simulation/LLG4.stan")
...
saveRDS(results, "~/Recidivism/res1000/simllg4.rds")


# Step 2: Apply the function to all simulation results
simulation_summaries <- lapply(results, extract_results)
saveRDS(simulation_summaries, "~/Recidivism/res1000/simllg4_summary.rds")
