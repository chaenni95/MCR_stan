...
stanmodel <- stan_model("~/Recidivism/simulation/wb4.stan")
...
saveRDS(results, "~/Recidivism/res1000/simwb4.rds")



# Step 2: Apply the function to all simulation results
simulation_summaries <- lapply(results, extract_results)
# saveRDS(simulation_summaries, "~/Recidivism/res1000/simwb4_summary.rds")
...
outdir <- "~/Recidivism/simulation3/res1000"
