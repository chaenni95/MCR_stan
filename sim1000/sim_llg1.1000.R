...
stanmodel <- stan_model("~/Recidivism/simulation/LLG1.stan")
...
saveRDS(results, "~/Recidivism/res1000/simllg1.rds")


# Step 2: Apply the function to all simulation results
simulation_summaries <- lapply(results, extract_results)
saveRDS(simulation_summaries, "~/Recidivism/res1000/simllg1_summary.rds")
