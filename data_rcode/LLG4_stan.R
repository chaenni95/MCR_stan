...
llg_sample <- stan_model("~/Recidivism/simulation/LLG4.stan")
llg_sample_fit <- sampling(llg_sample, data = iowa18_stan, seed = 12345, chains = 4, iter = 2000, init = 0,
                          pars = c("betaU", "betaC", "sigma", "alpha_fg", "lambda_fg", "lp__", "log_lik"))

saveRDS(llg_sample_fit, "~/Recidivism/dataresult/llg4.rds")
